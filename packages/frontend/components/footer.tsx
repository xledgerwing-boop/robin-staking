        ...
        <footer className="border-t border-border bg-card/50 backdrop-blur-sm sticky bottom-0 z-50">
            <div className="container mx-auto px-4 py-3 flex items-center justify-between gap-3">
                ...
                <nav className="flex items-center gap-2 sm:gap-4">
                    <Link
                        href="https://robin-markets.gitbook.io"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Gitbook Docs"
                    ...
                    <Link href="https://x.com/robinmarketsxyz" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
