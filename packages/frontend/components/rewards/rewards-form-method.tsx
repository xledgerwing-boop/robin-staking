...
export function RewardsFormMethod({ hasSubmittedFeedback }: { hasSubmittedFeedback: boolean }) {
    ...
    return (
        <div className="space-y-3">
            <div className="flex gap-4">
                <div className={cn('flex-1 p-3 border rounded-lg flex items-start justify-between', !hasDeposit && !loading ? 'animate-pulse' : '')}>
                ...
                <div
                    className={cn(
                        ...
                        !hasSubmittedFeedback && !loading && hasDeposit ? 'animate-pulse' : hasSubmittedFeedback ? 'opacity-100' : 'opacity-50'
                    )}
                >
                    <div className="w-full">
                        <div className="relative font-medium flex items-start justify-between w-full">
