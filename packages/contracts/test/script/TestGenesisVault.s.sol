...
contract TestGenesisVault is Script, GenesisConstants {
    ...
    function run() external {
        ...
        // 1) Deploy the RobinGenesisVault
        RobinGenesisVault vault = new RobinGenesisVault(CTF, UNDERLYING_USD, tvlCapUsd);
        ...
        GenesisMarketInfo[20] memory infos = getGenesisMarkets();
