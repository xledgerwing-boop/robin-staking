...
abstract contract GenesisConstants is Constants {
    // ---------- Genesis vault test constants ----------
    struct GenesisMarketInfo {
        bytes32 conditionId;
    ...
    uint256 internal constant GENESIS_FORK_BLOCK = 78926976;
    GenesisMarketInfo internal firstEligible =
        GenesisMarketInfo({
    ...
    GenesisMarketInfo internal firstNonEligible =
        GenesisMarketInfo({
    ...
    GenesisMarketInfo internal secondNonEligible =
        GenesisMarketInfo({
    ...
    function getGenesisMarkets() public view returns (GenesisMarketInfo[20] memory) {
        return [
            firstEligible,
            firstNonEligible,
            secondNonEligible,
