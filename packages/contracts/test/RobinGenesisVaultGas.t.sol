...
contract RobinGenesisVaultGasTest is Test, GenesisConstants, ForkFixture {
    // actors
    ...
    function setUp() public {
        ...
        GenesisMarketInfo[20] memory markets = getGenesisMarkets();
    ...
    function _mintOutcome(address to, GenesisMarketInfo memory market, uint256 amount) internal {
